...
public class CouchResponse {
	...
	CouchResponse(HttpRequestBase req, HttpResponse response) throws IOException {
		...
		if( entity.isStreaming() ) content = response.getEntity().getContent(); //EntityUtils.toByteArray(entity);
		//if( entity.isStreaming() ) content = EntityUtils.toByteArray(entity);
