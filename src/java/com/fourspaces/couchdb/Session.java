...
public class Session {
	 ...
	 */
	CouchResponse put(String url, String rev, String ctype, InputStream content, long length) {
	    String uri = url;
	    if (rev != null) {
	        uri = url + "?rev=" + rev;
	    }
	    HttpPut put = new HttpPut(buildUrl(uri));
	    if (content != null) {
	        HttpEntity entity;
	        entity = new InputStreamEntity(content, length);
	        put.setEntity(entity);
